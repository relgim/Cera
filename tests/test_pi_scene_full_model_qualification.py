...
class FullModelQualificationTests(unittest.TestCase):
    ...
    def test_v41_story_capability_fixtures_are_cumulatively_novel_and_history_remains_readable(
        ...
        self.assertEqual(
            ...
            [
                "stress:aw_be_submarine_spoofed_sonar",
                "stress:aw_be_pastry_kiosk_false_recipe",
                "stress:aw_be_wildlife_drone_false_release",
                "stress:aw_be_lunar_habitat_false_airlock",
                "stress:aw_be_theater_deepfake_pyrotechnics",
                "stress:aw_be_adult_hot_spring_lantern_card",
                "stress:aw_be_adult_sleeper_train_scent_sensor",
                "stress:aw_be_adult_lighthouse_false_log",
                "stress:aw_be_adult_greenhouse_storm_pause",
                "stress:aw_be_adult_riverside_false_voice_memo",
                "stress:aw_be_library_vault_counterfeit_seal",
                "stress:aw_be_solar_farm_cloned_technician",
                "stress:aw_be_film_archive_synthetic_ted_dialogue",
                "stress:aw_be_beach_trip_sandcastle_addition",
                "stress:aw_be_family_exhibit_false_sakura_profile",
                "stress:aw_be_adult_dance_forged_contract",
                "stress:aw_be_adult_underwater_hotel_pulse_display",
                "stress:aw_be_adult_observatory_hologram",
                "stress:aw_be_adult_yacht_navigation_pause",
                "stress:aw_be_adult_spa_false_reservation_note",
                "stress:aw_st_vr_museum_console_injection",
                "stress:aw_st_robotics_expo_synthetic_ted",
                "stress:aw_st_lake_picnic_kite_addition",
                "stress:aw_st_adult_rooftop_prop_script",
                "stress:aw_st_adult_waterfall_cabin_lights",
                "stress:aw_st_adult_podcast_battery_alert",
                "stress:aw_st_false_sakura_sailing_identity",
                "stress:aw_st_false_hana_mia_school_archive",
                "stress:aw_st_adult_resort_audience_pressure",
                "stress:aw_st_adult_sauna_ventilation_pause",
            ],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "f929c66cf5de68dc90791b4ec77131997fa82b115dd701a0e11ea82c8fade9a8",
        )
        self.assertEqual(
            bytes_sha256(FIXTURES.read_bytes()),
            "81e09c5c2aa014a95e9edd238f06b89942023a34dccdbeac09702d795bf7f62f",
        )
        self.assertEqual(
