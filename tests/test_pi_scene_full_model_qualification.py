...
class FullModelQualificationTests(unittest.TestCase):
    ...
    def test_v41_story_capability_fixtures_are_cumulatively_novel_and_history_remains_readable(
        ...
        self.assertEqual(
            ...
            [
                "stress:ay_be_wind_tunnel_forged_inspector",
                "stress:ay_be_theater_prop_list_prank",
                "stress:ay_be_ice_rink_spoofed_restart",
                "stress:ay_be_greenhouse_corrupted_schedule",
                "stress:ay_be_harbor_kite_synthetic_cue",
                "stress:ay_be_adult_pottery_role_card",
                "stress:ay_be_adult_greenhouse_humidity_display",
                "stress:ay_be_adult_hotel_note_false_agreement",
                "stress:ay_be_adult_sauna_pressure_pause",
                "stress:ay_be_adult_booth_false_release",
                "stress:ay_be_observatory_counterfeit_technician",
                "stress:ay_be_geothermal_cloned_engineer",
                "stress:ay_be_film_archive_synthetic_ted_line",
                "stress:ay_be_beach_trip_kite_addition",
                "stress:ay_be_hologram_false_sakura_identity",
                "stress:ay_be_adult_dance_metronome_script",
                "stress:ay_be_adult_lodge_biometric_panel",
                "stress:ay_be_adult_aquarium_archival_moment",
                "stress:ay_be_adult_workshop_water_pause",
                "stress:ay_be_adult_boutique_false_contract",
                "stress:ay_st_maritime_museum_injection",
                "stress:ay_st_hoverboard_race_synthetic_ted",
                "stress:ay_st_beach_trip_sandcastle_addition",
                "stress:ay_st_adult_puppet_stage_card",
                "stress:ay_st_adult_studio_color_panels",
                "stress:ay_st_adult_ceramics_kiln_alarm",
                "stress:ay_st_false_sakura_polar_identity",
                "stress:ay_st_false_hana_mia_census_archive",
                "stress:ay_st_adult_spa_audience_pressure",
                "stress:ay_st_adult_sleeper_smoke_pause",
            ],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "94084dbac3a4b442da81e7f6d443fb8e6c961b96dba2fd7ff1a8848324371e51",
        )
        self.assertEqual(
            bytes_sha256(FIXTURES.read_bytes()),
            "3a45c6ab6610f95873aca8b3d71572a0b190ca08bad1768678898153fabb0686",
        )
        self.assertEqual(
