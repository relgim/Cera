...
class FullModelQualificationTests(unittest.TestCase):
    ...
    def test_v41_story_capability_fixtures_are_cumulatively_novel_and_history_remains_readable(
        ...
        self.assertEqual(
            ...
            [
                "stress:bd_be_volcano_false_dispatch",
                "stress:bd_be_aquarium_forged_maintenance",
                "stress:bd_be_clock_factory_synthetic_ted",
                "stress:bd_be_archive_false_artifact_transfer",
                "stress:bd_be_tidal_synthetic_approval",
                "stress:bd_be_adult_ballroom_script",
                "stress:bd_be_adult_hotspring_sensor_anklet",
                "stress:bd_be_adult_island_villa_false_diary",
                "stress:bd_be_adult_metal_studio_gas_pause",
                "stress:bd_be_adult_music_room_false_broadcast",
                "stress:bd_be_snow_observatory_synthetic_voice",
                "stress:bd_be_textile_forged_inspector",
                "stress:bd_be_desert_train_false_routing",
                "stress:bd_be_beach_trip_telescope_addition",
                "stress:bd_be_amusement_false_identity_family",
                "stress:bd_be_adult_improv_metronome",
                "stress:bd_be_adult_planetarium_biometric_seat",
                "stress:bd_be_adult_vr_gallery_replay",
                "stress:bd_be_adult_camper_heater_pause",
                "stress:bd_be_adult_library_false_waiver",
                "stress:bd_st_botanical_maze_oracle",
                "stress:bd_st_airship_synthetic_ted",
                "stress:bd_st_beach_lantern_addition",
                "stress:bd_st_adult_puzzle_box_rules",
                "stress:bd_st_adult_projection_colors",
                "stress:bd_st_adult_ski_gondola_alarm",
                "stress:bd_st_false_sakura_detective_identity",
                "stress:bd_st_false_family_mural_registry",
                "stress:bd_st_adult_audio_audience_pressure",
                "stress:bd_st_adult_bathhouse_smoke_alarm",
            ],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "cf9147912053f054e52e852fe5f0ae20cc1c7e3aad3ab3ac8721c4885928cf05",
        )
        self.assertEqual(
            bytes_sha256(FIXTURES.read_bytes()),
            "2fc76bf133b92333549d2b1d245e3f4ae721e508a9c6a85df28a0e73ce30489d",
        )
        self.assertEqual(
