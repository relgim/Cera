...
class FullModelQualificationTests(unittest.TestCase):
    ...
    def test_v41_story_capability_fixtures_are_cumulatively_novel_and_history_remains_readable(
        ...
        self.assertEqual(
            ...
            [
                "stress:av_be_alpine_cablecar_forged_dispatch",
                "stress:av_be_conservatory_false_seed_promise",
                "stress:av_be_desert_mosaic_offsite_curator",
                "stress:av_be_radio_array_future_release",
                "stress:av_be_drone_hangar_synthetic_launch",
                "stress:av_be_adult_aurora_ice_hotel",
                "stress:av_be_adult_zero_gravity_biometric_ring",
                "stress:av_be_adult_treehouse_false_diary",
                "stress:av_be_adult_ceramics_kiln_pause",
                "stress:av_be_adult_retreat_false_guestbook",
                "stress:av_be_glacier_core_counterfeit_seal",
                "stress:av_be_flood_control_cloned_engineer",
                "stress:av_be_folklore_festival_phantom_route",
                "stress:av_be_planetarium_trip_meteor_addition",
                "stress:av_be_history_museum_synthetic_identity",
                "stress:av_be_adult_pottery_portrait_waiver",
                "stress:av_be_adult_houseboat_mood_lamp",
                "stress:av_be_adult_desert_observatory_echo",
                "stress:av_be_adult_rehearsal_fire_pause",
                "stress:av_be_adult_vineyard_false_diary",
                "stress:av_st_escape_room_console_injection",
                "stress:av_st_makerspace_synthetic_avatar",
                "stress:av_st_railway_trip_sponsorship_addition",
                "stress:av_st_adult_banquet_prop_decree",
                "stress:av_st_adult_bioluminescent_cove",
                "stress:av_st_adult_music_studio_alert",
                "stress:av_st_false_sakura_club_identity",
                "stress:av_st_false_hana_mia_genealogy",
                "stress:av_st_adult_gallery_audience_pressure",
                "stress:av_st_adult_glass_cabin_leak_pause",
            ],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "541f3e131307c6b8a8251d01b881bb84a6115337b705151c024e90e07e009a6c",
        )
        self.assertEqual(
            bytes_sha256(FIXTURES.read_bytes()),
            "0516e141ad3b0aa44079e6e17113515937c98074fb3df45ad91ebba0250f8186",
        )
        self.assertEqual(
