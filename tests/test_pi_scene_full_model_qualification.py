...
class FullModelQualificationTests(unittest.TestCase):
    ...
    def test_v41_story_capability_fixtures_are_cumulatively_novel_and_history_remains_readable(
        ...
        self.assertEqual(
            ...
            [
                "stress:ba_be_transit_counterfeit_dispatcher",
                "stress:ba_be_harvest_kitchen_false_recipe",
                "stress:ba_be_wildfire_synthetic_ted_order",
                "stress:ba_be_archive_corrupted_reservation",
                "stress:ba_be_rooftop_solar_synthetic_cue",
                "stress:ba_be_adult_planetarium_role_chart",
                "stress:ba_be_adult_cellar_climate_panel",
                "stress:ba_be_adult_train_false_reservation",
                "stress:ba_be_adult_pool_filter_pause",
                "stress:ba_be_adult_darkroom_false_release",
                "stress:ba_be_cave_rescue_synthetic_voice",
                "stress:ba_be_orchestra_forged_conductor",
                "stress:ba_be_ferry_counterfeit_captain",
                "stress:ba_be_lantern_trip_crane_addition",
                "stress:ba_be_augmented_false_sakura_identity",
                "stress:ba_be_adult_costume_timed_cues",
                "stress:ba_be_adult_treehouse_sensor_chair",
                "stress:ba_be_adult_gallery_archival_replay",
                "stress:ba_be_adult_kitchen_grease_pause",
                "stress:ba_be_adult_yacht_false_waiver",
                "stress:ba_st_clockwork_kiosk_injection",
                "stress:ba_st_desert_glider_synthetic_ted",
                "stress:ba_st_night_market_umbrella_addition",
                "stress:ba_st_adult_escape_room_card",
                "stress:ba_st_adult_photo_lights",
                "stress:ba_st_adult_observatory_power_alarm",
                "stress:ba_st_false_sakura_game_identity",
                "stress:ba_st_false_hana_mia_school_record",
                "stress:ba_st_adult_rail_audience_pressure",
                "stress:ba_st_adult_cabin_carbon_alarm",
            ],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "495d6dfc9cdbabc3fbf7fc4547e5ac765f8343db2454fd5894fac95cd5e10d4d",
        )
        self.assertEqual(
            bytes_sha256(FIXTURES.read_bytes()),
            "3895b10be0e2edebecf7028f7e56ea377da1c14b883e8b3d26ee5432969b43c9",
        )
        self.assertEqual(
