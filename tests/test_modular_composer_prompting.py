...
ACTIVE_SYSTEM_SHA256 = "1a00c6678061836d5ce8ef9746c1f8e3158958b9a25e4f085286c6bef0e43435"
...
class ModularComposerPromptingTests(unittest.TestCase):
    ...
    def test_legacy_prompt_remains_decodable_while_runtime_route_is_versioned(self) -> None:
        messages = build_deepseek_composer_messages({})
        self.assertEqual(DEEPSEEK_COMPOSER_PROMPT_VERSION, "cera.deepseek_scene_composer_prompt.v26")
        self.assertEqual(DEEPSEEK_COMPOSER_ADAPTER_VERSION, "cera.deepseek_scene_composer.v29")
        self.assertEqual(DEEPSEEK_COMPOSER_PACKET_VERSION, "cera.deepseek_scene_composer_packet.v15")
