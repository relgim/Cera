...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v36.json"
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV36 for value in fixtures):
        raise StateConflictError("live qualification requires novel practical fixtures v36")
...
def _load_spent_qualification_manifests(
    *,
    ...
    """Load cumulative V5-V39 manifest authority for all completed prior roots.
