...
LEGACY_FIXTURES_V9 = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v9.json"
LEGACY_FIXTURES_V10 = (
...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v40.json"
    ...
    fixture_artifacts = tuple(
        dict.fromkeys(
            (
                ...
                LEGACY_FIXTURES_V12.relative_to(ROOT),
                LEGACY_FIXTURES_V13.relative_to(ROOT),
                LEGACY_FIXTURES_V14.relative_to(ROOT),
                LEGACY_FIXTURES_V15.relative_to(ROOT),
                LEGACY_FIXTURES_V16.relative_to(ROOT),
                LEGACY_FIXTURES_V17.relative_to(ROOT),
                LEGACY_FIXTURES_V18.relative_to(ROOT),
                LEGACY_FIXTURES_V19.relative_to(ROOT),
                LEGACY_FIXTURES_V20.relative_to(ROOT),
                LEGACY_FIXTURES_V21.relative_to(ROOT),
                LEGACY_FIXTURES_V22.relative_to(ROOT),
                LEGACY_FIXTURES_V23.relative_to(ROOT),
                LEGACY_FIXTURES_V24.relative_to(ROOT),
                LEGACY_FIXTURES_V25.relative_to(ROOT),
                LEGACY_FIXTURES_V26.relative_to(ROOT),
                LEGACY_FIXTURES_V27.relative_to(ROOT),
                LEGACY_FIXTURES_V28.relative_to(ROOT),
                LEGACY_FIXTURES_V29.relative_to(ROOT),
                LEGACY_FIXTURES_V30.relative_to(ROOT),
                LEGACY_FIXTURES_V31.relative_to(ROOT),
                LEGACY_FIXTURES_V32.relative_to(ROOT),
                LEGACY_FIXTURES_V33.relative_to(ROOT),
            )
        )
    )
    return {
...
class IsolatedSillyTavernQualificationClient:
    ...
    def probe_provider_stage_relay(
        ...
        *,
        ...
        terminal_completion_decision = validate_ordinary_review_decision_v3(
        ...
        repair_completion_decision = validate_ordinary_review_decision_v3(repair_completion.body)
        ...
        validated_reviews = {
            "decline_review": validate_ordinary_review_v3(decline_review.body),
            "regenerate_review": validate_ordinary_review_v3(regenerate_review.body),
        }
        validated_decisions = {
            "decline": validate_ordinary_review_decision_v3(decline.body),
            "decline_terminal": validate_ordinary_review_decision_v3(decline_terminal.body),
            "regenerate": validate_ordinary_review_decision_v3(
                regenerate.body,
                successor_validator=validate_ordinary_successor_completion,
            ),
            "regenerate_terminal": validate_ordinary_review_decision_v3(
                regenerate_terminal.body,
                successor_validator=validate_ordinary_successor_completion,
            ),
            "terminal_completion": terminal_completion_decision,
            "accepted_terminal_reload": validate_ordinary_review_decision_v3(
                accepted_terminal_reload.body
            ),
            "prepared_completion": validate_ordinary_review_decision_v3(prepared_completion.body),
            "repair_completion": repair_completion_decision,
            "repair_completion_reload": validate_ordinary_review_decision_v3(
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV40 for value in fixtures):
        raise StateConflictError("live qualification requires novel story-capability fixtures v40")
...
def _load_spent_qualification_manifests(
    *,
    ...
    """Load cumulative V5-V43 manifest authority for all completed prior roots.
    ...
    omit an earlier novel suite. Explicit paths extend the authority to campaigns
    outside the output-root parent.
    """
                ...
                [
                    {
                        ...
                        "feedback_scope": "whole_candidate_quality",
...
def _relay_provisional_completion(review_id: str) -> dict[str, Any]:
    ...
    lifecycle = validate_ordinary_review_lifecycle_v2(
        {
...
def live(
    *,
    ...
    try:
        ...
        standing_policy_acceptances = int(backend["standing_policy_provisional_acceptances"]) + int(
            st_result["standing_policy_provisional_acceptances"]
        )
        ...
        result = {
            "schema_version": "cera.pi_scene.full_model_complete_qualification.v5",
            ...
            "standing_policy_provisional_acceptances": standing_policy_acceptances,
