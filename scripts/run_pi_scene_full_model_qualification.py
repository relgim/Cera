...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v35.json"
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV35 for value in fixtures):
        raise StateConflictError("live qualification requires novel practical fixtures v35")
...
def _load_spent_qualification_manifests(
    *,
    ...
    """Load cumulative V5-V38 manifest authority for all completed prior roots.
