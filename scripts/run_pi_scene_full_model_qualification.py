...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v41.json"
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV41 for value in fixtures):
        raise StateConflictError("live qualification requires novel story-capability fixtures v41")
