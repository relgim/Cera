...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v23.json"
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV23 for value in fixtures):
        raise StateConflictError("live qualification requires novel stress fixtures v23")
...
def _load_spent_qualification_manifests(
    *,
    ...
    """Load cumulative V5-V26 manifest authority for all completed prior roots.
