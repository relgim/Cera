...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v20.json"
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV20 for value in fixtures):
        raise StateConflictError("live qualification requires novel stress fixtures v20")
...
def _load_spent_qualification_manifests(
    *,
    ...
    """Load cumulative V5-V23 manifest authority for all completed prior roots.
