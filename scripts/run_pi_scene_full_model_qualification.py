...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v21.json"
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV21 for value in fixtures):
        raise StateConflictError("live qualification requires novel stress fixtures v21")
...
def _load_spent_qualification_manifests(
    *,
    ...
    """Load cumulative V5-V24 manifest authority for all completed prior roots.
