...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v28.json"
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV28 for value in fixtures):
        raise StateConflictError("live qualification requires novel practical fixtures v28")
...
def _load_spent_qualification_manifests(
    *,
    ...
    """Load cumulative V5-V31 manifest authority for all completed prior roots.
