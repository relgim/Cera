...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v22.json"
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV22 for value in fixtures):
        raise StateConflictError("live qualification requires novel stress fixtures v22")
...
def _load_spent_qualification_manifests(
    *,
    ...
    """Load cumulative V5-V25 manifest authority for all completed prior roots.
