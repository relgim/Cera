...
DEFAULT_FIXTURES = ROOT / "evaluation" / "fixtures" / "pi_scene_full_model_qualification_v7.json"
...
def freeze(
    *,
    ...
    if not fixtures or not all(type(value) is QualificationFixtureV7 for value in fixtures):
        raise StateConflictError("live qualification requires novel stress fixtures v7")
...
def _load_spent_qualification_manifests(
    *,
    ...
    """Load cumulative V5/V6/V7/V8/V9/V10 fixture authority from this root family.
