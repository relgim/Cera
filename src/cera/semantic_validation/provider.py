...
LUNA_VALIDATOR_ADAPTER = "cera.semantic_validation.luna_adapter.v4"
LUNA_VALIDATOR_PROMPT = "cera.semantic_validation.luna_prompt.v2"
...
def luna_validator_route() -> LiveProviderRoute:
    return replace(
        ...
        route_id="cera_semantic_validator_luna_xhigh_v4",
