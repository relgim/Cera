...
def build_validator_prompt(
    *,
    ...
    writer_text_custody = None
    if writer_mechanical_envelope is not None:
        writer_text_custody = {
            "schema_version": "cera.validator_writer_text_custody.v1",
            "python_validated": True,
            **{
                key: writer_mechanical_envelope[key]
                for key in (
                    "candidate_id",
                    "story_text_sha256",
                    "codepoint_count",
                )
                if key in writer_mechanical_envelope
            },
        }
    request = {
        "schema_version": "cera.continuous_validator_request.v14",
        ...
        "python_validated_writer_text_custody": writer_text_custody,
