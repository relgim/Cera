...
CONTINUOUS_VALIDATOR_PROMPT_VERSION = "cera.continuous_validator_prompt.v20"
...
def build_validator_prompt(
    *,
    ...
    request = {
        "schema_version": "cera.continuous_validator_request.v7",
