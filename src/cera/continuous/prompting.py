...
CONTINUOUS_VALIDATOR_PROMPT_VERSION = "cera.continuous_validator_prompt.v26"
...
def build_validator_prompt(
    *,
    ...
    request = {
        "schema_version": "cera.continuous_validator_request.v10",
        ...
        "writer_realization_boundary": to_primitive(boundary),
        "authority_note": (
