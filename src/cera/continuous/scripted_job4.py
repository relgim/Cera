...
class ScriptedJob4FixtureRuntime:
    ...
    def _validator_value(self, prompt: str) -> ContinuousSemanticValidatorDraftV10:
        harness = self._current()
        ...
        if harness._active_validator_label == "scene-1-validator-summary":
            ...
            return ContinuousSemanticValidatorDraftV10.from_v4(ContinuousSemanticValidatorDraftV4(
